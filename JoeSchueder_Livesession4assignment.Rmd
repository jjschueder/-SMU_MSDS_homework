---
title: "JoeSchueder_Livesession4assignment"
author: "Joe Schueder"
...
#Column count
ncol(df)
#count of unique categories and assign to major count
major_count <- lapply(df, table)
major_count$major_category
par(las=2) 
par(mar=c(5,20,4,2)) 
barplot(major_count$major_category,
        main="Major Category Bar Plot",
     xlab="Count of Categories",
     ylab="Categories",
     horiz = TRUE,
     col ="blue")

write.csv(major_count$major_category, "538college.csv", row.names=FALSE)

```

##Git location:  https://github.com/jjschueder/SMU_MSDS_homework.git